...
QVector<Buff> Buff::library()
{
    return {
        ...
        Buff(QStringLiteral("流感季节"), QStringLiteral("宿舍楼集体感冒，但同学互帮互助让人暖心。"), EffectTarget::AllStudents, 0, -5, 8, 0),
        ...
        Buff(QStringLiteral("考试周断电"), QStringLiteral("复习计划被打乱，学校发放应急补助。"), EffectTarget::AllStudents, -5, 0, -8, 30),
        ...
        Buff(QStringLiteral("图书馆占座风波"), QStringLiteral("争抢座位引发不快，但来回跑动也算锻炼。"), EffectTarget::AllStudents, 0, 6, -4, 0),
        ...
        Buff(QStringLiteral("补考通知"), QStringLiteral("成绩不佳压力山大，但开始规律作息。"), EffectTarget::AllStudents, -3, 7, -5, 0),
